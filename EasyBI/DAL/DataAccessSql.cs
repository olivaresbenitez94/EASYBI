...
namespace EasyBI
{
    ...
    /// </summary>
    public sealed class DataAccessSql
    {
        ...
        /// <summary>
        /// Execute a text SqlCommand (that returns no resultset and takes no parameters) against the default database
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        /// <summary>
        /// Execute a SqlCommand (that returns no resultset and takes parameters) against the default database
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ///  int result = ExecuteNonQuery("update ");
        ...
        public static int ExecuteNonQuery(SqlConnection connection, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            ...
            {
                log.insertarLog(true, "[DATA_ACCESS SQL SERVER] " + sqlEx.Message, 0);
                log.insertarLog(true, "   " + sqlEx.StackTrace, 0);
                return -1;
            }
            catch (Exception ex)
            {
                log.insertarLog(true, "[DATA_ACCESS SQL SERVER] " + ex.Message, 0);
                log.insertarLog(true, "   " + ex.StackTrace, 0);
                return -1;
            }
        }
        ...
        /// <summary>
        /// Execute a text SqlCommand (that returns a result table and takes no parameters) against the default database 
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ///  DataSet ds = ExecuteDataTable("GetOrders");
        /// </remarks>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        ...
        /// <summary>
        /// Execute a SqlCommand (that returns a result table and takes no parameters) against the database specified in 
        /// the connection string. 
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        /// <remarks>
        /// e.g.:  
        ///  DataSet ds = ExecuteDataTable(connString, CommandType.StoredProcedure, "GetOrders", new SqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connectionString">a valid connection string for a SqlConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        ...
        /// 
        /// e.g.:  
        ///  DataSet ds = ExecuteDataTable(connString, "GetOrders", 24, 36);
        /// </remarks>
        /// <param name="connectionString">a valid connection string for a SqlConnection</param>
        /// <param name="spName">the name of the stored procedure</param>
        /// <param name="parameterValues">an array of objects to be assigned as the input values of the stored procedure</param>
        ...
        /// <remarks>
        /// e.g.:  
        ///  DataSet ds = ExecuteDataTable(conn, CommandType.StoredProcedure, "GetOrders");
        /// </remarks>
        /// <param name="connection">a valid SqlConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        ...
        /// <remarks>
        /// e.g.:  
        ///  DataSet ds = ExecuteDataTable(conn, CommandType.StoredProcedure, "GetOrders", new SqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connection">a valid SqlConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
            ...
            try
            {
                ...
                */
                ...
                using (DataSet ds = new DataSet())
                {
                    ...
                    if (ds.Tables.Count > 0) return ds.Tables[0].Copy(); //Para poder añadirlo a otro dataSet
                    else return null;
                }                
        ...
        /// 
        /// e.g.:  
        ///  DataSet ds = ExecuteDataTable(conn, "GetOrders", 24, 36);
        /// </remarks>
        /// <param name="connection">a valid SqlConnection</param>
        /// <param name="spName">the name of the stored procedure</param>
        /// <param name="parameterValues">an array of objects to be assigned as the input values of the stored procedure</param>
        ...
        /// <remarks>
        /// e.g.:  
        ///  DataSet ds = ExecuteDataTable(trans, CommandType.StoredProcedure, "GetOrders");
        /// </remarks>
        /// <param name="transaction">a valid SqlTransaction</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        /// <returns>a dataset containing the resultset generated by the command</returns>
        public static DataSet ExecuteDataTable(SqlTransaction transaction, CommandType commandType, string commandText)
        {
            //pass through the call providing null for the set of SqlParameters
        ...
        /// <remarks>
        /// e.g.:  
        ///  DataSet ds = ExecuteDataTable(trans, CommandType.StoredProcedure, "GetOrders", new SqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="transaction">a valid SqlTransaction</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        /// <param name="commandParameters">an array of SqlParamters used to execute the command</param>
        /// <returns>a dataset containing the resultset generated by the command</returns>
        public static DataSet ExecuteDataTable(SqlTransaction transaction, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            try
            {
                //create a command and prepare it for execution
        ...
        /// 
        /// e.g.:  
        ///  DataSet ds = ExecuteDataTable(trans, "GetOrders", 24, 36);
        /// </remarks>
        /// <param name="transaction">a valid SqlTransaction</param>
        /// <param name="spName">the name of the stored procedure</param>
        /// <param name="parameterValues">an array of objects to be assigned as the input values of the stored procedure</param>
        /// <returns>a dataset containing the resultset generated by the command</returns>
        public static DataSet ExecuteDataTable(SqlTransaction transaction, string spName, params object[] parameterValues)
        {
            //if we receive parameter values, we need to figure out where they go
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
        ...
        /// <summary>
        /// Execute a SqlCommand (that returns a 1x1 resultset and takes parameters) against the database specified in 
        /// the connection string. 
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        public static object ExecuteScalar(SqlConnection connection, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            ...
            {
                log.insertarLog(true, Environment.UserName + "[DATA_ACCESS SQL SERVER] " + sqlEx.Message, 0);
                log.insertarLog(true, "   " + sqlEx.StackTrace, 0);
                return null;
            }
            catch (Exception ex)
            {
                log.insertarLog(true, Environment.UserName + "[DATA_ACCESS SQL SERVER] " + ex.Message, 0);
                log.insertarLog(true, "   " + ex.StackTrace, 0);
                return null;
            }
        }
